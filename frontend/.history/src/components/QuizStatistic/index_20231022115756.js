...
import { Card, Col, Row, Statistic, Space, Progress } from 'antd';
...
const QuizStatistic = () => {
  ...
  <Progress type="circle" percent={75} style={{marginRight: '100px'}} />
  <Progress type="circle" percent={70} status="exception" style={{marginRight: '100px'}} />
