...
const FloatingPanel = (0, _react().forwardRef)((props, ref) => {
  ...
  const onTouchMove = event => {
    ...
    if (visibleH.goal >= maxAnchor && bodyEL) {
      if (touch.firstMove.current && ( // try going up to body top
      touch.deltaY.current > 0 && (0, _utils.getScrollTop)(bodyEL) > 0 || // try going down to body bottom
